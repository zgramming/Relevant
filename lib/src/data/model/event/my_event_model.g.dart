...
part of 'my_event_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MyEventModel _$MyEventModelFromJson(Map<String, dynamic> json) => MyEventModel(
      id: json['id'] as int? ?? 0,
...
Map<String, dynamic> _$MyEventModelToJson(MyEventModel instance) =>
    <String, dynamic>{
      'id': instance.id,
